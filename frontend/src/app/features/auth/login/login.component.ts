  ...
  template: `
    <div class="w-full">
      ...
      <div class="mb-8">
        ...
        <p class="text-sm text-text-muted">Sign in to continue to your account</p>
      </div>

      <!-- Error Alert -->
      @if (error()) {
        <div
          class="mb-6 flex items-start gap-3 p-4 rounded-lg bg-danger-soft border border-danger/20 text-danger text-sm animate-scale-in"
        >
          <svg class="w-5 h-5 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
            <path
              fill-rule="evenodd"
              d="M10 18a8 8 0 100-16 8 8 0 0016 8zm3.707-9.293a1 1 0 010 1.414L9 14.414 7.707 13.121a1 1 0 011.414-1.414L8 11.586l2.293-2.293a1 1 0 011.414 0z"
              clip-rule="evenodd"
            />
          </svg>
          <span>{{ error() }}</span>
              ...
              @if (showPassword()) {
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                    ...
                    stroke-linejoin="round"
                    stroke-width="2"
                    d="M13.875 18.825A10.05 10.05 0 0112 19c-7 0-11-8-11-9s4-9 11-9c1.353 0 2.687.27 3.875.75M6.73 6.73A5.99 5.99 0 0012 5c3.314 0 6 2.686 6 3 0 .36-.086.701-.239.99M15 12a3 3 0 11-6 0 3 3 0 016 0z"
                  />
                </svg>
              } @else {
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <p class="mt-8 text-center text-sm text-text-muted">
        ...
        <a
          ...
          class="font-medium text-accent hover:underline transition-colors"
          >Create one now</a
        >
      </p>
    </div>
